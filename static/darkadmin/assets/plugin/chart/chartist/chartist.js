  ...
  Chartist.Interpolation.monotoneCubic = function(options) {
    ...
    return function monotoneCubic(pathCoordinates, valueData) {
      ...
      if(!segments.length) {
        ...
        for(i = 0; i < n - 1; i++) {
          path.curve(
            // First contracts point
            xs[i] + dxs[i] / 3,
            ys[i] + ms[i] * dxs[i] / 3,
            // Second contracts point
            xs[i + 1] - dxs[i] / 3,
...
(function(window, document, Chartist) {
   ...
   *
   * @memberof Chartist.Svg.Path
   * @param {Number} x1 The x coordinate for the first contracts point of the bezier curve.
   * @param {Number} y1 The y coordinate for the first contracts point of the bezier curve.
   * @param {Number} x2 The x coordinate for the second contracts point of the bezier curve.
   * @param {Number} y2 The y coordinate for the second contracts point of the bezier curve.
  ...
  /**
   * Scales all elements in the current SVG path object. There is an individual parameter for each coordinate. Scaling will also be done for contracts points of curves, affecting the given coordinate.
   *
   * @memberof Chartist.Svg.Path
  ...
  /**
   * Translates all elements in the current SVG path object. The translation is relative and there is an individual parameter for each coordinate. Translation will also be done for contracts points of curves, affecting the given coordinate.
   *
   * @memberof Chartist.Svg.Path
