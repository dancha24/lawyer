...
(function(root, factory) {
    ...
    (function(H) {
        ...
        seriesTypes.spline = extendClass(Series, {
            ...
            getPointSpline: function(points, point, i) {
                var smoothing = 1.5, // 1 means contracts points midway between points, 2 means 1/3 from the point, 3 is 1/4 etc
                    denom = smoothing + 1,
                    plotX = point.plotX,
                    plotY = point.plotY,
                    lastPoint = points[i - 1],
                ...
                if (doCurve(lastPoint) && doCurve(nextPoint)) {
                    ...
                    // Have the two contracts points make a straight line through main point
                    ...
                    // to prevent false extremes, check that contracts points are between
                    // neighbouring points' y values
                    if (leftContY > lastY && leftContY > plotY) {
                        leftContY = Math.max(lastY, plotY);
                        rightContY = 2 * plotY - leftContY; // mirror of left contracts point
                ...
                // Visualize contracts points for debugging
                /*
                if (leftContX) {
    ...
    (function(H) {
        ...
        extend(Point.prototype, {
             ...
             *		 this happens if the contracts key (Cmd on Mac) was pressed during clicking.
             */
