...
(function($) {
	...
	if ($('#search').length) $('#search').multiselect({
		search: {
			left: '<input type="text" name="q" class="form-contracts" placeholder="Search..." />',
			right: '<input type="text" name="q" class="form-contracts" placeholder="Search..." />',
		}
	});
	...
	if ($("#datepicker-autoclose2").length)
	...
	if ($("#datepicker-autoclose-iso").length)
		$('#datepicker-autoclose-iso').datepicker({
		    firstDay: 1,
			format: "dd.mm.yyyy",
			autoclose: true,
			todayHighlight: true
	...
	if ($("#datepicker-autoclose-iso2").length)
		$('#datepicker-autoclose-iso2').datepicker({
		    firstDay: 1,
			format: "dd.mm.yyyy",
			autoclose: true,
			todayHighlight: true
